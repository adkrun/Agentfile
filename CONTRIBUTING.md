...
1. Check whether the change you want to introduce is not already present in the base repository.
   Main base repository can be cloned from: https://github.com/adkrun/Specification
2. Check whether the change you want to introduce has not been already submitted by someone else.
    - https://github.com/adkrun/Specification/pulls
...
2. Clone your copy of base `git clone git@github.com:adkrun/Specification.git`.
...
6. Wait for an Agent Development Kit author to review your changes.
...
additional inactivity the PR will automatically be closed except if one of the Agent Development Kit authors will label it with
